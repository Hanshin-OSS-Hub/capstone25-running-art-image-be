 ...
 * 정적 팩토리 메서드인 {@link #toResponse(String, String, Instant)}를 통해 인스턴스를 생성해야 합니다.
 *
...
public record RefreshTokenIssueResponse(
    ...
    public static RefreshTokenIssueResponse toResponse(String refreshToken, String jti, Instant issuedAt) {
