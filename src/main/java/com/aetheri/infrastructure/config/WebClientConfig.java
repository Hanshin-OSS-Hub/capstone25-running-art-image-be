...
/**
 * 카카오 API와의 비동기 통신을 위해 **{@code WebClient} 인스턴스 및 커넥션 설정을 정의**하는
 * Spring {@code @Configuration} 클래스입니다.
 *
 * <p>카카오의 일반 API와 인증(Auth) API를 위해 각각 다른 {@code WebClient} 빈을 생성하며,
 * 각 빈에 타임아웃 설정을 적용합니다.</p>
 */
@Configuration
